...
describe('Create Account', () => {
  ...
  const mockAccount = {
    ...
    let fakeCreateAccountRepository: any;
    let createAccountService: CreateAccountService

    beforeEach(()=>{
      fakeCreateAccountRepository = {
        findByEmail: () => null,
        create: jest.fn().mockReturnValueOnce({...mockAccount, id:0})
      }
...
jest.spyOn(fakeCreateAccountRepository, 'findByEmail').mockReturnValue(
   Promise.resolve( {
    id:1,
    fullName: 'string',
    email: 'string',
